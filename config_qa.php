<?php
	...
	if(isset($_POST['recherche'])){
		...
		if(!empty($_POST['id_type']) OR !empty($_POST['id_cat'])){
			$_SESSION['id_type']		= trim($_POST['id_type']);
			$_SESSION['id_cat']		= trim($_POST['id_cat']);
	...
	$query = "SELECT * FROM videos WHERE rubrique='Questions d'actualité' ORDER BY id_videos DESC ";
