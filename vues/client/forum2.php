...
<!-- ####################################################################################################### -->
	<div class="wrapper row3" style="margin-top: 120px">
			<div id="container" class="clear">
                ...
                <b><a style="text-decoration: none; margin: 10px;" href="?c=affSuj&code=<?php echo($sjts['id_sujet']) ?>"><?php echo($sjts['sujet'])?></a></b>
             <?php }?></div>
                           ...
                           <?php   $Commentaires = new Commentaires(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

		$affCommentaires = $Commentaires->affichageCommentaires2(); ?>
      ...
      <div class="pagination">
        <a href="?c=forum">&laquo;</a>
        <a href="?c=forum" >1</a>
        <a href="#" class="active">2</a>
        <a href="?c=forum3">3</a>

        <a href="?c=forum3">&raquo;</a>
      </div>
    </div>
