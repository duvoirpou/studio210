    ...
    <div id="container" class="clear" style="">
        <div class="container spacer col-md-6 col-xs-12 col-md-offset-3" id="homepage" style="margin-top:30px; ">
		  ...
		  <div class="panel panel-default">
			...
			<div class="panel-heading" style="height: 100px; padding-top: 35px;"><img class="imgl" src="images/<?php echo($Commentaires['photo'])?>" style="border-radius: 100%; margin-top: -25px" alt="" width="80" height="80" /> <b><?php echo($Commentaires['pseudo']); ?></b></div>
				
			<div class="panel-body">
				<?php if(isset($Commentaires['commentaire'])){ echo($Commentaires['commentaire']);} ?>
        <?php /* if(isset($Co['comment_vid']) AND !isset($Commentaires['commentaire'])){ echo($Co['comment_vid']);} ?>
                  <?php $re = new Reponses(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
