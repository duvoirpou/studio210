			...
			<div id="container" class="clear"> 
				...
				<div id="homepage" class="clear"> 
					...
					<div id="content">
								...
								<div id="latestnews" style="width:580px; padding-top: 20px;">
													<h2 style="color: #DAA520;">Titre</h2>
														<ul>
															
															
												<?php while($comm=$affCommentaires->fetch()){?>
														  <li>
                                ...
                                <p style="text-align: justify; margin-top: 20px;">
                                  ...
                                  <span><strong><?php echo($comm['prenom_user'])?> <?php echo($comm['nom_user'])?></strong></span><br>
                                  <script>
																			var recupe;
																		var texte="<?php echo($comm['commentaire'])?>";
                                    
                                    if(texte.length>=201){
																		var posi=texte.substr(0,201);
																		function trouv(){
																			return posi;
																		}
																		recupe=trouv();
																...
																<p class="readmore" style="margin-top: 70px;"><a href="?c=affComm&code=<?php $_SESSION['id_commentaire'] = $comm['id_commentaire']; echo($comm['id_commentaire'])?>">Lire tout &raquo;</a></p>
															</li><?php }?>
        ...
        ';}
			?>
              ...
              <div class="holder last" id="rubrique">
							<h2 style="color: #DAA520;"><!--Etudiant &amp; -->Choisir une rubrique à commenter</h2>
