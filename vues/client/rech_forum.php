...
<li class="last"><a  href="gallery.php" style="text-decoration: none">Galeries</a>
	...
	<!-- ####################################################################################################### -->
	<div class="wrapper row3" style="margin-top: 120px" id="home" data-spy="scroll" data-target="#navbar-example">
					...
					<div id="latestnews" style="width:100%; padding-top: 50px;">
						<h2 style="color: #DAA520; text-align: center">
							<i><?php while($sjt=$affSujets->fetch()){?>
								<?php $_SESSION['id_sujet']=$sjt['id_sujet']; $_SESSION['sujet']=$sjt['sujet']; ?>
								<?php }?> <?php echo($_SESSION['sujet']) ?> </i>
						</h2>
						<ul>
							<?php
	...
	<div class="container" style="padding-left: 100px">
		...
		<input class="button btn btn-default" type="submit" name="publier" value="Publier"
			...
			<br><a style="text-decoration: none;" href="?c=affSuj&code=<?php echo $_SESSION['id_sujet']; ?>">Actualisez</a>
		</form><br><br><br><br>
	</div>
	</div>
	<!-- ####################################################################################################### -->
