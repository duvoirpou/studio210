...
<!-- ####################################################################################################### -->
	<div class="wrapper row3" style="margin-top: 120px">
			<div id="container" class="clear">
                ...
                <b><a style="text-decoration: none; margin: 10px;" href="?c=affSuj&code=<?php /*$_SESSION['sjts']=$sjts['id_sujet'];*/ echo($sjts['id_sujet']) ?>"><?php echo($sjts['sujet'])?></a></b>
             <?php }?></div>
                            ...
                            <i>
                                ...
                                $affCommentairesSujets = $CommentairesSujets->affichageCommentairesSujetSelect2();
                              ?>
        ...
        <p>
          <form action="" method="post">
          <input type="number" name="id_sujet" placeholder="id_user" value="'.$_SESSION['suj'].'" hidden/>
      ...
      <div class="pagination">
        ...
        <a href="?c=affSuj3">3</a>

        <a href="?c=affSuj3">&raquo;</a>
      </div>
    </div>
