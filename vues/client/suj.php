...
<body id="top">
				...
				<div id="content" style="width:100%;">
					...
					<div id="latestnews" style="width:100%; padding-top: 50px;">
						...
						<ul>
							...
							<li>
								<p class="readmore"><span style="float: left"><i><?php echo($comm['heure_commentaire'])?>h
	...
	<div class="container" style="padding-left: 100px">
		...
		<input class="button btn btn-default" type="submit" name="publier" value="Publier"
			...
			<br><a style="text-decoration: none;" href="?c=affSuj&code=<?php echo $_SESSION['id_sujets']; ?>">Actualisez</a>
		</form><br><br><br><br>
	</div>
	<!-- ####################################################################################################### -->
