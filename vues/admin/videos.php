...
<div class="wrapper row3">
    <div id="container-fluid" class="clear">
        <!-- ####################################################################################################### -->
		...
		<div class="card">
			...
			<div class="table-responsive">
				<h4 class="card-title text-center">Vidéos(s)</h4>
          ...
          <thead>
							...
							<tbody>
									...
									<tr>
										<td><?php echo($et['id_videos'])?></td>
										<td><video poster="" controls src="videos/<?php echo($et['videos'])?>" style="height: 100px; width: 100px"></video></td>
										<!---affichage de la photo---->
										<td>
											<?php echo($et['theme'])?>
										</td>
										<td><?php echo($et['msg_videos'])?></td>
										<td><?php echo($et['rubrique'])?></td>
										<td><?php echo($et['date_video'])?></td>
										...
										<td style="text-align:center">
											<!---MODIFICATION----><a class="a_lien" style="margin-left:5px;" href="?c=modifVideos&code=<?php echo($et['id_videos'])?>">
												<button class="btn btn-primary" type="button">Modifier</button>
											</a>
										<!---SUPPRESSION---->
											<a class="a_lien" style="margin-left:5px;" onclick="return confirm('Confirmer la suppression ?');" href="?c=supprVid&code=<?php echo($et['id_videos'])?>">
