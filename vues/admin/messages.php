    ...
    <div id="container-fluid" class="clear">
		...
		<div class="card">
			...
			<div class="table-responsive">
				<h4 class="card-title text-center">Message(s)</h4>
          ...
          <thead>
							...
							<tbody>
									...
									<tr>
										...
										<td><?php echo($et['objet'])?></td>
										<td>
											<p>
											<script>
										var recupe;
										var texte = "<?php echo($et['message'])?>";
										if (texte.length > 32) {
										var posi = texte.substr(0, 32);
										...
										<td><?php echo($et['date_message'])?></td>
										<td><?php echo($et['mois_message'])?></td>
										<td><?php echo($et['annee_message'])?></td>
										...
										<td style="text-align:center">
											<a class="a_lien" style="margin-left:5px;" href="?c=modifMsg&code=<?php echo($et['id_messages'])?>">
												Lire
											</a>
										<!---SUPPRESSION--
