	...
	<body>
		<div class="container" style="margin-top:150px;">
			<div class="row">
				...
				<div class="col-md-4">
					<button type="button" class="btn btn-primary btn-lg btn-block">CONNEXION</button>
				</div>
				<div class="col-md-4"></div>
			</div>
			...
			<form style="margin-top:30px;" method="POST" action="">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="aemail" name="nom_admin" placeholder="Votre adresse email">
				</div>
