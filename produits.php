...
<div class="shell" style="">
  ...
  <div class="vivi" style="position:absolute; margin-top:23px; margin-left:10px;" ><nav class="navbar navbar-light " style="background-color: #778899;">
    ...
    <!-- Cart -->
    <div id="cart" style="background-color:"> <a href="index.php?c=pan" class="cart-link"><i class="fab fa-opencart" style="font-size:16px;"></i>Voir le panier</a>
  ...
  <div class="client" style="background-color:; width:177px">
      <?php
        ...
        echo '<div style="" class="nom_client"><b>'.$_SESSION['nom_client'].'</b>|<a href="index.php?c=dcx_client" style="text-decoration: none"><b>déconnexion</b></a></div>';}
      ?>
      </div>
  ...
  <div id="main">
    ...
    <div class="products" style="margin-left: 228px;">
    <div class="cl">&nbsp;</div>
    <div class="ligne" id="">
    <?php
        ...
        <ul>
          <li> <a ><img src="images/<?php echo $results->data[$i]['photo']?>"/></a>
            ...
            <a id="editer" href="produits.php?limit=<?php echo($_SESSION['limit'])?>&page=<?php echo($_SESSION['page'])?>&ajouter=<?php echo($results->data[$i]['id_produits'])?>" id=""><i class="fa fa-cart-arrow-down" style="font-size:25px; margin-left:-10px; margin-top:10px"></i>
												 </a>
											</div>
          </div>
          </li>
