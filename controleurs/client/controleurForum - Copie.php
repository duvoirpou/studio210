<?php
	...
	if(isset($_POST['enregistrer'])){
		...
		move_uploaded_file($fichierTempo, 'images/'.$photo);
			...
			$Ins_users = new User (NULL,$nom_user,$prenom_user,$tel,$pseudo,$mpass,$photo,$permis);
	...
	if(isset($_POST['publier'])){
		...
		$AjouterCommentaires = new Commentaires (NULL,$commentaire,$id_user,$annee_commentaire,$heure_commentaire,$minute_commentaire,$date_commentaire);
	...
	if($reponse){
		...
		$Commentaires = new Commentaires(NULL,NULL,NULL,NULL,NULL,NULL,NULL);
